...
| 模块 | 描述 | 安装量 |
| --- | ---- | :---: |
| [Nice Menus](https://www.drupal.org/project/nice_menus) | 提供下拉菜单，兼容性强，禁用js情况下还可工作 | 84w+ |
...
| [JavaScript API 概览](https://www.drupal.org/docs/7/api/javascript-api/javascript-api-overview) | Drupal8 在页面初始化的时候或者获取数据时候提供了一些API，详细介绍了 JavaScript 是如何在 Drupal 中运行的，遵循官方的开发规范是良好开发的第一步 |
